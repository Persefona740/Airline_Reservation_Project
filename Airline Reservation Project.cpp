// Anna Cebula, IT, extramural studies
...
class Details //user details
{
    public:
        ...
        void information()
        {
            cout << "\nEnter the customer ID, that should be the number from 0 to 99: "; // that could be the number from 0 to 99
            cin >> cId;
            cout << "\nEnter the name : ";
            cin >> name;
            cout << "\nEnter the age : ";
            cin >> age;
            cout << "\nCity or town name: "; // that could be just city or town name
            cin >> add;
            cout << "\nGender: ";
            cin >> gender;
...
class Registration //that allows to display available flights, where user can book a flight
{
    public:
        ...
        void flights()
        {
            ...
            cout << "\nPress the number of the country where you want to book a flight: ";
            cin >> choice;
            ...
            switch (choice)
            {
                case 1:
                {
                    ...
                    cout << "1. DUB - 123" << endl;
                    cout << "\t08-01-2049 8:00AM 7h PLN 1700" << endl;
                    cout << "2. DUB - 456" << endl;
                    cout << "\t09-01-2049 4:00AM 9h PLN 1300" << endl;
                    cout << "3. DUB - 789" << endl;
                    cout << "\t11-01-2049 10:00AM 8h PLN 1500" << endl;
                    ...
                    cout << "Press 5 and Enter to go back to the main menu: " << endl;
                    cin >> back;
                ...
                case 2:
                {
                    ...
                    cout << "1. ACA - 123" << endl;
                    cout << "\t08-01-2049 9:00AM 11h PLN 3900" << endl;
                    cout << "2. ACA - 456" << endl;
                    cout << "\t09-01-2049 3:00AM 12h PLN 4300" << endl;
                    cout << "3. ACA - 789" << endl;
                    cout << "\t11-01-2049 11:00AM 11h PLN 3700" << endl;
                ...
                case 3:
                {
                    ...
                    cout << "1. UKA - 123" << endl;
                    cout << "\t08-01-2049 7:00AM 2h PLN 300" << endl;
                    cout << "2. UKA - 456" << endl;
                    cout << "\t09-01-2049 10:00AM 3h PLN 400" << endl;
                ...
                case 4:
                {
                    ...
                    cout << "1. USA - 123" << endl;
                    cout << "\t09-01-2049 7:00AM 11h PLN 3900" << endl;
                    cout << "2. USA - 456" << endl;
                    cout << "\t11-01-2049 5:00AM 12h PLN 4300" << endl;
                    cout << "3. USA - 789" << endl;
                    cout << "\t14-01-2049 9:00AM 11h PLN 3700" << endl;
                ...
                case 5:
                {
                    ...
                    cout << "1. AUL - 123" << endl;
                    cout << "\t04-01-2049 2:00AM 21h PLN 7300" << endl;
                    cout << "2. AUL - 456" << endl;
                    cout << "\t19-01-2049 6:00AM 23h PLN 6400" << endl;
                ...
                case 6:
                {
                    ...
                    cout << "1. IBE - 123" << endl;
                    cout << "\t03-01-2049 1:00AM 2h PLN 400" << endl;
                    cout << "2. IBE - 456" << endl;
                    cout << "\t07-01-2049 10:00AM 3h PLN 500" << endl;
                    cout << "3. IBE - 789" << endl;
                    cout << "\t10-01-2049 08:00AM 2h PLN 400" << endl;
...
void mainMenu() //main menu function
{
    ...
    cout << "\t(Please follow step by step according to the numbers in the menu)" << endl;
    ...
    cout << "\t|\t Press 3 for Ticket details               \t|" << endl;
    cout << "\t|\t Press 4 to Exit                          \t|" << endl;
    cout << "\t|\t\t\t\t\t\t\t|" << endl;
    cout << "\t|\t Optional 0 to return at each step        \t|" << endl;
    cout << "\t|\t\t\t\t\t\t\t|" << endl;
    ...
    switch (lchoice)
    {
        ...
        case 1/* switch case inside*/:
            ...
            d.information();
            cout << "Press 5 and Enter to go back to the main menu: ";
            cin >> back;
        ...
        case 3:
            ...
            cout << "Press 1 and Enter to display ticket ";

            cin >> back;
                if (back==1)
                {
                    t.dispbill();
                    cout << "Press 5 and Enter to back to main menu ";
                    cin >> back;
